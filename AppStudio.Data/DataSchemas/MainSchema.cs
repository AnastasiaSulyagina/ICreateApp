...
namespace AppStudio.Data
{
    ...
    /// </summary>
    public class MainSchema : BindableSchemaBase, IEquatable<MainSchema>, ISyncItem<MainSchema>
    {
        ...
        public bool NeedSync(MainSchema other)
        {
        ...
        public void Sync(MainSchema other)
        {
        ...
        {
            return Equals(obj as MainSchema);
        }
